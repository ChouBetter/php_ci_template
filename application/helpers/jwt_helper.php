...
class jwt_helper extends CI_Controller {
    ...
    const CONSUMER_KEY = CONSUMER_KEY; // please replace YOUR_XX
    const CONSUMER_SECRET = CONSUMER_SECRET; // please replace YOUR_XX
    const CONSUMER_TTL = CONSUMER_TTL; // second | 1 day
